...
$i=count($resultat)-1; // on associe la longueur du tableau -1(car quand on le parcour on l'index commence a 0 et non pas a 1);
while ($i>=0){
...
//var_dump($resultatshop);
// echo("nom du commerce : " );
// echo($resultatshop[0]['name'] . "<br>");


}// echo($resultat[$i]['phonenumber'] );
$i=$i-1;
}

// $sqlQuery = "SELECT * FROM shop;"; // recupere l'id de l'user connecté en cours dans un tableau associatif
// $donne = $mysqlConnection->prepare($sqlQuery);
// $donne->execute();
// $resultatshop = $donne->fetchAll();
// var_dump($resultatshop);
