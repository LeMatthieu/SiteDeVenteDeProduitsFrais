      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 mt-5">
          ...
          <p class="fs-5">Les foodtruck sont souvent installé a un même endroit constamment pour avoir une certaine régularité sur leur position. <br>
            Cependant il est souvent difficile de les trouver sans les croiser ou sans avoir une connaissance qui sait leur position. <br>
            Désormais il suffit d'un clic pour trouver ceux qui sont à proximité !
          </p>
        </div>
      </div>
    </div>
