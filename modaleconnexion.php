      ...
      <div class="modal-body">
        <form method="POST">
          ...
          <div class="mb-3">
            ...
            <div class="form-text">
              Votre mot de passe doit contenir une lettre, un chiffre, et avoir une longueur entre 8 et 20 caractère.
            </div>
            <div class="mb-3">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post"> <!-- action permet d'appeller le fichier -->
          ...
          <p>Numéro de téléphone : <input type="text" name="editphone" value="<?php echo ($_SESSION['myphonenumber']); ?>"></p>
